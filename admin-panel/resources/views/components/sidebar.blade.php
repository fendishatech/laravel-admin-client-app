<div class="sidebar py-4">
    ...
    <ul>
        ...
        <li
            class="py-2 text-white flex items-center justify-start px-6 hover:text-gray-900 hover:bg-gray-100 hover:rounded-l-[18px]">
            <a href="/clients" class="w-full"><i class="fa fa-user-circle mr-3" aria-hidden="true"></i> Cleints</a>
        </li>
        <li
            class="py-2 text-white flex items-center justify-start px-6 hover:text-gray-900 hover:bg-gray-100 hover:rounded-l-[18px]">
            <a href="/members" class="w-full"><i class="fa fa-user-circle mr-3" aria-hidden="true"></i> members</a>
        </li>
